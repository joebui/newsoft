...
namespace newsoft.Controllers
{
    public class NewsController : Controller
    {
        ...
        {
            var news = db.News.Include(n => n.Subcategory);
        ...
        public ActionResult Create([Bind(Include = "id,subcategoryID,title,shortdesc,content")] News news)
        {
            ...
            ViewBag.subcategoryID = new SelectList(db.Subcategories, "id", "name", news.subcategoryID);
            return View(news);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,subcategoryID,title,shortdesc,content")] News news)
        {
            if (ModelState.IsValid)
            {
